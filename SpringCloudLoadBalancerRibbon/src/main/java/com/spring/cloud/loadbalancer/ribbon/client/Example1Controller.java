package com.spring.cloud.loadbalancer.ribbon.client;
...
public class Example1Controller {
	...
	public String home() {
		...
		return "<a href='testCallXyzService'>/testCallXyzService</a>";
	}

	@ResponseBody
	@RequestMapping(value = "/testCallXyzService", method = RequestMethod.GET)
	...
	public String hello() {
		...
		return "<html>Hello from XYZ-SERVICE</html>";
	}
